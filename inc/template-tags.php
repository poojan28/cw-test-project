...
if ( ! function_exists( 'code_wing_test_project_breadcrumb' ) ) {

	/**
	 * Prints breadcrumb.
	 */
	function code_wing_test_project_breadcrumb( $display = true ) {

		if ( ! class_exists( 'code_wing_test_project_Breadcrumb_Trail' ) && ! function_exists( 'code_wing_test_project_breadcrumb_trail' ) ) {
		...
		$breadcrumb_html = code_wing_test_project_breadcrumb_trail( $args );
...
if ( ! function_exists( 'code_wing_test_project_banner' ) ) {

	/**
	 * Prints the banner html.
	 */
	function code_wing_test_project_banner() {
		get_template_part( 'template-parts/content', 'banner' );
	}
}


if ( ! function_exists( 'code_wing_test_project_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function code_wing_test_project_posted_on() {
...
if ( ! function_exists( 'code_wing_test_project_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function code_wing_test_project_posted_by() {
		?>
...
if ( ! function_exists( 'code_wing_test_project_entry_comment_link' ) ) {
	/**
	 * Prints the html for comment link.
	 */
	function code_wing_test_project_entry_comment_link() {
...
if ( ! function_exists( 'code_wing_test_project_entry_category_lists' ) ) {
	/**
	 * Prints the html for category listing.
	 */
	function code_wing_test_project_entry_category_lists() {
...
if ( ! function_exists( 'code_wing_test_project_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function code_wing_test_project_entry_footer() {
...
if ( ! function_exists( 'code_wing_test_project_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function code_wing_test_project_post_thumbnail() {
